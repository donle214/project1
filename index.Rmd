...
*The plot above depicts Heart Disease Death Counts by State and Year. By plotting a barplot, I am able to see the heart disease death counts for each state. This reveals that in states like California, Florida, New York, and Texas with very large populations, it makes sense that the bars/bins for Heart disease death counts are much higher than in states with a very small population. Using position = "fill" in geom_bar, I was able to split each bar into their respective years and show how much each year contributes to the total. From this, I was able to see a trend that shows mostly decreasing Heart Disease death counts as the years progress.*
